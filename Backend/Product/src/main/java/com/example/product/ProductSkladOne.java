...
@Entity
@Table(name = "skladodin")
public class ProductSkladOne implements BaseProduct{
    ...
    // Конструкторы
    public ProductSkladOne() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    public ProductSkladOne(String name, Double price, Integer count, String akticul,
