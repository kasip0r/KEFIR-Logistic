...
@Entity
@Table(name = "skladtri")
public class ProductSkladThree implements BaseProduct{
    ...
    // Конструкторы
    public ProductSkladThree() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    public ProductSkladThree(String name, Double price, Integer count, String akticul,
